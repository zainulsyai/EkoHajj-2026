        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 mb-8 relative z-10">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 md:gap-5">
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center bg-gradient-to-br from-[#059669] to-[#047857] text-white shadow-xl shadow-[#059669]/20 ring-2 md:ring-4 ring-white/50">
                <ShoppingCart className="w-6 h-6 md:w-8 md:h-8" strokeWidth={1.5} />
              </div>
              <div>
                <h1 className="text-lg md:text-2xl font-bold text-[#059669] font-playfair leading-tight mb-1 md:mb-0">Monitoring Beras</h1>
                <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 rounded-full bg-[#059669]/10 border border-[#059669]/20 text-[9px] md:text-[10px] font-bold text-[#059669] uppercase tracking-widest">Konsumsi Jemaah Haji</span>
                </div>
              </div>
            </div>
          </div>
