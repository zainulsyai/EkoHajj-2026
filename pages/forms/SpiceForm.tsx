...
export const SpiceForm: React.FC<SpiceFormProps> = ({ onBack }) => {
  ...
  return (
    <div className="flex flex-col relative font-sans bg-white/60 backdrop-blur-xl rounded-[2.5rem] border border-white/60 shadow-2xl overflow-hidden transition-all duration-500 pb-32">
