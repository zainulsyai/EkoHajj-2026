         ...
         <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 mb-8 relative z-10">
             <div className="flex items-center gap-6">
                 ...
                 <div className="flex items-center gap-3 md:gap-5">
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center shadow-lg shadow-[#7C3AED]/20 bg-gradient-to-br from-[#7C3AED] to-[#6D28D9] text-white ring-2 md:ring-4 ring-white/50">
                        <Signal className="w-6 h-6 md:w-8 md:h-8" strokeWidth={1.5} />
                    </div>
                    <div>
                        <h1 className="text-lg md:text-2xl font-bold text-[#7C3AED] font-playfair leading-tight mb-1 md:mb-0">Telekomunikasi</h1>
                        <div className="flex items-center gap-2">
                             <span className="px-2 py-0.5 rounded-full bg-[#7C3AED]/10 border border-[#7C3AED]/20 text-[9px] md:text-[10px] font-bold text-[#7C3AED] uppercase tracking-widest">Potensi Provider Jemaah</span>
                        </div>
                    </div>
                 </div>
             </div>
